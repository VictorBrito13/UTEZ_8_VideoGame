...
COMPETITIVE_ITEMS = [
  ...
  },
  {
    "name": "X-Attack",
    "slug": "x-attack",
    "description": "Increases damage by 50% for this battle.",
  ...
  },
  {
    "name": "X-Defense",
    "slug": "x-defense",
    "description": "Increases defense by 50% for this battle.",
  ...
  },
  {
    "name": "X-Speed",
    "slug": "x-speed",
    "description": "Freezes the opponent, skipping their next turn.",
