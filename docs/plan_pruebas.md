...
Documento orientado a validación manual en el entorno productivo. Cada caso incluye la **operación**, los **pasos** y el **resultado esperado**.
...
## Registro de ejecución (uso recomendado)

Para cada caso, anotar: **fecha**, **ejecutor**, **entorno (prod)**, **resultado** (OK / No OK) y **observaciones** si el resultado difiere del esperado.